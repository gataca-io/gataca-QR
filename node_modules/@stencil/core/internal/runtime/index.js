/*
 Stencil Runtime v0.0.0-dev.20200211192258 | MIT Licensed | https://stenciljs.com
 */
'use strict';
...
const createElm = (oldParentVNode, newParentVNode, childIndex, parentElm) => {
    ...
    if (appData.BUILD.vdomText && newVNode.$text$ !== null) {
        ...
        elm = newVNode.$elm$ = (appData.BUILD.isDebug || appData.BUILD.hydrateServerSide) ? slotReferenceDebugNode(newVNode) : platform.doc.createTextNode('');
    }
    else {
...
const appDidLoad = (who) => {
    ...
    if (appData.BUILD.lifecycleDOMEvents) {
        platform.nextTick(() => emitLifecycleEvent(platform.doc, 'appload'));
    }
...
const setContentReference = (elm) => {
    ...
    // create a node to represent where the original
    // content was first placed, which is useful later on
    const contentRefElm = elm['s-cr'] = platform.doc.createComment(appData.BUILD.isDebug
...
const bootstrapLazy = (lazyBundles, options = {}) => {
    ...
    const styles = platform.doc.querySelectorAll(`[${HYDRATED_STYLE_ID}]`);
    let appLoadFallback;
