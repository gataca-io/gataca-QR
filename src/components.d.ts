...
export namespace Components {
    interface GatacaQr {
        ...
        "dynamicLink"?: boolean;
        /**
          * ***Mandatory*** Callback fired upon session expired or invalid If not set, session error would not be handled
         */
        ...
        /**
          * ***Mandatory*** Callback fired upon session correctly verified If not set, session validation wouldn't trigger any action
         */
