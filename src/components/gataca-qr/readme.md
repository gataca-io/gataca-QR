...
| `clickInsideBoxReadedQrLabel`  | `click-inside-box-readed-qr-label`  | _[Optional]_ String to show "click inside" label for QR already read                                                                                                                                                            | `string`                                                                | `"Click the box to refresh."`                                         |
...
| `readedQrLabel`                | `readed-qr-label`                   | _[Optional]_ String to show when QR already read                                                                                                                                                                                | `string`                                                                | `"QR Code already scanned."`                                          |
