...
export class GatacaQR {
     ...
     */
    @Prop() qrModalDescription?: string = 'Sign up or sign in by scanning the QR Code with the Gataca Wallet';
     ...
     */
    @Prop() credentialsNotValidatedLabel?: string = 'User credentials not validated';
     ...
     */
    @Prop() userNotScanInTimeErrorLabel?: string = 'User did not scan the QR in the allowed time';

    /**
     * _[Optional]_
     * String to show "provided credentials not validates" error
     */
    @Prop() credsNotValidatedErrorLabel?: string = "Provided user credentials couldn't be validated";
    ...
    async poll() {
        ...
        let checkFunc = async (component: GatacaQR): Promise<{result: RESULT_STATUS; data?: any}> => {
                ...
                >
                    <div class="modal-window__content">
                        <div class={`qrTitleContainer ${this.hideModalTexts ? 'hidenText' : ''}`}>
                            ...
                            {this.result !== RESULT_STATUS.SUCCESS && !this.hideQrModalDescription && <p class="qrDescription modalText">{this.qrModalDescription}</p>}
                        </div>
                        <div
                            class="qrSection"
                            style={{
