...
| `autostart`                    | `autostart`                         | _[Optional]_ Set to start polling when button or QR is displayed. By default it is true                                                                                                                                                         | `boolean`                                                                                                    | `true`                                                                |
| `buttonDCAPIText`              | `button-d-c-a-p-i-text`             | _[Optional]_ In the case of enabling DCAPI button, allows to configure the text displayed                                                                                                                                                       | `string`                                                                                                     | `'Login with Device Credentials'`                                     |
...
| `checkAppTimeout`              | `check-app-timeout`                 | _[Optional]_ Maximum time window to check if the App is installed                                                                                                                                                                               | `number`                                                                                                     | `6`                                                                   |
...
| `enableDcApi`                  | `enable-dc-api`                     | _[Optional]_ String to show "waiting start session" label                                                                                                                                                                                       | `boolean`                                                                                                    | `false`                                                               |
...
| `fillSession`                  | --                                  | ***Mandatory if DC API*** Sends the API response                                                                                                                                                                                                | `(request: any, sessionData?: any) => Promise<{ result: RESULT_STATUS; data?: any; }>`                       | `undefined`                                                           |
...
| `qrStyle`                      | --                                  | _[Optional]_ Adjust the color styles of the QR                                                                                                                                                                                                  | `{ color: string; bgColor: string; alertBgColor?: string; alertBorderColor?: string; boxShadow?: boolean; }` | `undefined`                                                           |
...
| ---------------------- | -------------------------------------------------------------------------- | ------------------ |
| `gatacaButtonPushed`   | GatacaLoginCompleted event, triggered with session data upon login success | `CustomEvent<any>` |
