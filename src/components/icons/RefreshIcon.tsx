...
type IRefreshIconProps = {
    height?: number;
    width?: number;
    color?: string;
};

export const RefreshIcon: React.FC<IRefreshIconProps> = (props) => {
    ...
    return (
        <svg width={width} height={height} viewBox={`0 0 ${width} ${height}`} fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M23 4V10H17" stroke={strokeColor} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
            <path
